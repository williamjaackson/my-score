/*
  ...
  - Made the column `nearby_user_id` on table `proximity_sessions` required. This step will fail if there are existing NULL values in that column.
  - Made the column `user_id` on table `proximity_sessions` required. This step will fail if there are existing NULL values in that column.
